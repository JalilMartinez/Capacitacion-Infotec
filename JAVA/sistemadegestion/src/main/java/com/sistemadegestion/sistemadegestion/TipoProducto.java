...
public class TipoProducto {
    ...
    public int[] generaArray(){
        int a[] = {Integer.parseInt(this.producto1),
                    Integer.parseInt(this.producto2),
                    Integer.parseInt(this.producto3),
                    Integer.parseInt(this.producto4),
                    Integer.parseInt(this.producto5),
                    Integer.parseInt(this.producto6),
                    Integer.parseInt(this.producto7),
                    Integer.parseInt(this.producto8),
                    Integer.parseInt(this.producto9),
                    Integer.parseInt(this.producto10),
                    Integer.parseInt(this.producto11),
                    Integer.parseInt(this.producto12),
                    Integer.parseInt(this.producto13),
                    Integer.parseInt(this.producto14),
                    Integer.parseInt(this.producto15),
                    Integer.parseInt(this.producto16),
                    Integer.parseInt(this.producto17),
    ...
    public void actualizaProductos(int a[]){
        this.producto1= Integer.toString(a[0]);
        this.producto2= Integer.toString(a[1]);
        this.producto3= Integer.toString(a[2]);
        this.producto4= Integer.toString(a[3]);
        this.producto5= Integer.toString(a[4]);
        this.producto6= Integer.toString(a[5]);
        this.producto7= Integer.toString(a[6]);
        this.producto8= Integer.toString(a[7]);
        this.producto9= Integer.toString(a[8]);
        this.producto10= Integer.toString(a[9]);
        this.producto11= Integer.toString(a[10]);
        this.producto12= Integer.toString(a[11]);
        this.producto13= Integer.toString(a[12]);
        this.producto14= Integer.toString(a[13]);
        this.producto15= Integer.toString(a[14]);
        this.producto16= Integer.toString(a[15]);
        this.producto17= Integer.toString(a[16]);
        this.producto18= Integer.toString(a[17]);
        this.producto19= Integer.toString(a[18]);
        this.producto20= Integer.toString(a[19]);
